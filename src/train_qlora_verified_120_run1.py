...
TRAIN_PATH = Path(
    ...
    "train_verified_108.jsonl"
)

VALIDATION_PATH = Path(
    "data/training/verified_120/splits/"
    "validation_verified_12.jsonl"
)

OUTPUT_DIR = Path(
    "outputs/qlora_verified_120_run1"
)
...
def main() -> None:
    ...
    print("\n" + "=" * 72)
    print("شروع QLoRA دیتاست ۱۲۰تایی")
    ...
    print("\n" + "=" * 72)
    print("آموزش دیتاست ۱۲۰تایی با موفقیت تمام شد.")
