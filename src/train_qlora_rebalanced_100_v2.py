...
TRAIN_PATH = Path(
    ...
    "train_rebalanced_90.jsonl"
)

VALIDATION_PATH = Path(
    "data/training/rebalanced_100_v2/"
    "validation_rebalanced_10.jsonl"
)

OUTPUT_DIR = Path(
    "outputs/qlora_rebalanced_100_v2"
)
...
def main() -> None:
    ...
    print("\n" + "=" * 72)
    print("شروع QLoRA نسخه متعادل ۱۰۰تایی")
    print("تعداد Epoch:", NUM_TRAIN_EPOCHS)
    ...
    print("\n" + "=" * 72)
    print("آموزش نسخه متعادل ۱۰۰تایی با موفقیت تمام شد.")
